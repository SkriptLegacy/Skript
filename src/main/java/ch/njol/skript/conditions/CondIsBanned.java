		...
		return players.check(e, new Checker<Object>() {
			...
			public boolean check(final Object o) {
				if (o instanceof Player) {
					...
					return Bukkit.getIPBans().contains(o) || !ipBanned && CollectionUtils.contains((Bukkit.getBannedPlayers().toArray(new OfflinePlayer[Bukkit.getBannedPlayers().size()])), new Predicate<OfflinePlayer>() {
						@Override
